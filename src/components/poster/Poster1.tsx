  ...
  return (
    <div className="flex w-[60%] max-[800px]:w-[100%] float-right h-[400px] max-[800px]:h-[220px] gap-20 max-[800px]:gap-5 max-[800px]:translate-x-0 -translate-x-[10%] pl-5">
      <div className="my-10">
        ...
        <p className="text-5xl font-light mt-2 max-[800px]:text-sm tracking-wider">
      ...
      <img
        src="/speaker.png"
        className="scale-125 max-[800px]:scale-100 max-[800px]:w-[150px] animate-slideInFromRight"
      />
    </div>
  );
}
